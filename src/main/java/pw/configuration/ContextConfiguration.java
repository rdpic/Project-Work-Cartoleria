...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = {"pw.controller","pw.service","pw.dao","pw.configuration"})
@EnableTransactionManagement
@PropertySource(value = {"classpath:application.properties"})
@EnableJpaRepositories(basePackages = {"pw.dao"}, entityManagerFactoryRef = "emf", transactionManagerRef = "tmf")
