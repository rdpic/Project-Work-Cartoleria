...
(14, 'Cartuccia Epson Ciano', 'Cartuccia compatibile Epson T1302 Cervo CIANO 945 pagine per Stampanti: Epson STYLUS OFFICE B42WD, Epson STYLUS OFFICE BX320FW, Epson STYLUS OFFICE BX525, Epson STYLUS OFFICE BX525WD, Epson STYLUS OFFICE BX535WD, Epson STYLUS OFFICE BX625, Epson STYLUS OFFICE BX625FWD, Epson STYLUS OFFICE BX630FW, Epson STYLUS OFFICE BX635FWD, Epson STYLUS OFFICE BX925FWD, etc.', 20, 3, 2.4, '976480'),
(15, 'Cartuccia Epson Nero', 'Cartuccia compatibile Epson T1301 Cervo NERO 945 pagine per Stampanti: Epson STYLUS OFFICE B42WD, Epson STYLUS OFFICE BX320FW, Epson STYLUS OFFICE BX525, Epson STYLUS OFFICE BX525WD, Epson STYLUS OFFICE BX535WD, Epson STYLUS OFFICE BX625, Epson STYLUS OFFICE BX625FWD, Epson STYLUS OFFICE BX630FW, Epson STYLUS OFFICE BX635FWD, Epson STYLUS OFFICE BX925FWD, etc.', 30, 3, 3.2, '273906'),
(16, 'Toner Xerox Nero', 'Toner compatibile Xerox 106R01147 NERO 10000 pagine per Stampanti: Xerox PHASER 6350', 8, 3, 11.5, '357895'),
(17, 'Toner Magenta', 'Toner compatibile Xerox 106R01145 MAGENTA 8000 pagine per Stampanti: Xerox PHASER 6350', 12, 3, 11.2, '273590'),
(18, 'Carta per stampanti', 'Nonostante l’avvento del digitale stampe e fotocopie sono ancora oggi un articolo estremamente diffuso. In ufficio, a scuola e nelle università, negli studi professionali, a casa e in ogni attività commerciale si ha continuamente a che fare con fogli di carta e di ogni tipo. Nel nuovo catalogo MondOffice abbiamo pensato a un vasto assortimento di offerte per carta per stampanti e fotocopiatrici, articoli versatili e specifici per ogni esigenza che possano garantire risultati impeccabili e costi contenuti.', 140, 2, 7.8, '346890'),
(19, 'Carta speciale laser e inkjet', 'Film adesivo bianco lucido adatto per fotocopiatrici a colori e monocromatiche e stampanti laser adatto anche per macchine con temperatura di fissaggio elevata. Questo film bianco dissoluto per stampanti laser a colori offre presentazioni di visualizzazione brillanti e veritiere e può essere utilizzato come un toner universale a colori. ', 27, 2, 14.8, '137051'),
(20, 'Busta imbottita', 'Leggere, resistenti e di facile utilizzo le buste imbottite con pluriball sono dotate di semplice chiusura autoadesiva per una sigillatura rapida e affidabile. ', 40, 5, 2.6, '356786'),
(21, 'Nastro da imballaggio', 'Il nastro adesivo in PVC (Polivinilcloruro) è l\'ideale per qualsiasi tipo di imballo (vetro, legno, plastica, cartone), garantisce una resistenza a lunga durata, senza lasciare residui di colla sulle superfici. Particolarmente indicato per pacchi pesanti è resistente agli agenti atmosferici e gode di buona bagnabilità.', 55, 5, 3.8, '188700'),
(22, 'Scatola di cartone', 'Lo scatolone è un contenitore di forma generalmente parallelepipeda o cilindrica e munito di coperchio usato per riporre o trasportare materiali solidi di vario genere.', 80, 5, 2.3, '118933'),
(23, 'Tubo per spedizione', 'Tubi per spedizioni sono ideali per la spedizione di prodotti come poster, stampe, tele, manifesti e disegni. Leggeri, resistenti agli urti e molto sicuri, i tubi per spedizioni in cartone avana dallo spessore di 1,5 mm con tappi in plastica trasparente. Leggeri, economici ma altamente protettivi.', 25, 5, 5, '119951'),
...
(26, 'Tastiera PC', 'La tastiera è una serie ordinata di tasti la cui pressione permette l\'inserimento, nella memoria del computer, di un particolare carattere, oppure l\'esecuzione di un particolare comando da parte del computer.', 10, NULL, 25, '257830');
